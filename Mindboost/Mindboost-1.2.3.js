...
function getBotResponse(input) {
	...
	if (input.includes("hey") || input === "hi" || input === "hi mindboost" || input === "hi how are you" || input.includes("hello") || input.includes("hiya") || input.includes("hi") && input.includes("mindboost")) {
		let ArrayBotResponse = ["Hi 👋🏻, How are you feeling today?", "Hello, How are you feeling today? 😊", "Hello there 👋🏻, How are you feeling today?", "Hey there mate, How are you feeling today?", "Hallo mate, How are you feeling today?", "Hoi mate, How are you feeling today?", "Hey buddy, How are you feeling today?", "Aloha mate, How are you feeling today?", "Hiya, How are you feeling today?", "Hi mate, How are you feeling today?", "Hello mate, How are you feeling today?", "Hi there👋, How are you feeling today?", "What's up buddy, How are you feeling today?",
	...
	if ((input === "safe mode") || (input === "/safemode")){
		let ArrayBotResponse = ["You are in safe mode.","(You are in safe mode)","Safe mode is enabled."];
		BotResponse = ArrayBotResponse[Math.floor(Math.random() * ArrayBotResponse.length)];
		return [BotResponse];
	}
	///////////////////////////////////////////Nice to meet you
